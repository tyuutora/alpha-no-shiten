---
category: 撮影テクニック
description: SONY αで動き物を撮る初心者向けに、AF-C、トラッキング、被写体認識、シャッター速度、連写の設定を被写体別に解説。ピント外れと被写体ブレの見分け方も分かります。
---
...
レンズを買い足す前に「いま困っているのは焦点距離不足か、設定や撮り方か」を見分けることも大切です。機材選びで迷い始めたら、[レンズ沼の意味と初心者が後悔しない対策](https://tyuutora-a.com/lens-numa/)で一度撮影目的を整理してから考えるのも一つの方法です。
